...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={['#003DA5', '#00236D']} // Shifted towards darker blue
        style={[styles.blueContainer, {width: width, paddingBottom: 50}]}
        start={{x: 0, y: 0}}
        end={{x: 1, y: 1}}>
...
const styles = StyleSheet.create({
  ...
  loginButton: {
    ...
    borderRadius: 25,
    marginBottom: 15,
    width: '100%', // Ensuring the button fills the container's width
  },
  kakaoButton: {
    backgroundColor: '#FEE500', // Background color for Kakao login button
  },
  naverButton: {
    backgroundColor: '#2DB400', // Background color for Naver login button
  },
  loginIcon: {
    width: 24,
    height: 24,
