    ...
    try {
      ...
      const response = await axios.post(
        ...
        JSON.stringify({
          ...
          type: 'bloodpressure',
          value: {
            systolic: targetSteps,
            diastolic: actualSteps,
          },
        }),
      ...
      if (response.status === 201) {
        Alert.alert('저장 성공', '혈압 수치가 성공적으로 저장되었습니다.');
  ...
  return (
    <ScrollView
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>혈압 입력하기</Text>
      </View>
      ...
      <View
        ...
        <View style={{flex: 1}}>
          <WebView
            source={{
              uri: `http://43.202.219.28:8000/common/bpchart?token=${token}`,
            }}
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          placeholder="최고 혈압 (Systolic, mmHg)"
        ...
        <TextInput
          ...
          placeholder="최저 혈압 (Diastolic, mmHg)"
          keyboardType="numeric"
          placeholderTextColor="#3C5A99"
        />
