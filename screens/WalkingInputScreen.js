  ...
  const saveSteps = async () => {
    try {
      ...
      if (response.status === 201) {
        Alert.alert('저장 성공', '걸음 수가 성공적으로 저장되었습니다.');
  ...
  return (
    <ScrollView
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>걷기 입력하기</Text>
      </View>
      ...
      <View
        ...
        <View style={{flex: 1}}>
          <WebView
            source={{
              uri: `http://43.202.219.28:8000/common/walkingchart?token=${token}`,
            }}
...
export default WalkingInputScreen;
